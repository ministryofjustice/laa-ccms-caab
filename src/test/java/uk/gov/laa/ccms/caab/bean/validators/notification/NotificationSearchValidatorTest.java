...
class NotificationSearchValidatorTest {
  ...
  void testCaseRefLengthValidation() {
    criteria.setCaseReference("123456789012345678901234567890123456!");
    validator.validate(criteria, errors);
    assertTrue(errors.hasErrors());
    assertEquals(2, errors.getErrorCount());
  ...
  void testClientSurnameLengthValidation() {
    criteria.setClientSurname("A234567890123456789012345678901234  56");
    validator.validate(criteria, errors);
    assertTrue(errors.hasErrors());
    assertEquals(2, errors.getErrorCount());
  ...
  void testProviderCaseRefLengthValidation() {
    criteria.setProviderCaseReference("123456789012345678901234567890123  456");
    validator.validate(criteria, errors);
    assertTrue(errors.hasErrors());
    assertEquals(2, errors.getErrorCount());
    assertEquals(
