...
public class ApplicationSearchControllerTest {
  ...
  class ApplicationSearchTests {
    ...
    public void getApplicationSearchPopulatesDropdowns() throws Exception {
      ...
      assertThat(mockMvc.perform(get("/application/search").sessionAttr("user", user)))
          .hasStatusOk()
    ...
    public void getApplicationSearchHandlesMissingLookupData() throws Exception {
      ...
      assertThat(mockMvc.perform(get("/application/search").sessionAttr(USER_DETAILS, user)))
          .failure()
          .hasCauseInstanceOf(CaabApplicationException.class)
          .hasRootCauseMessage("Failed to retrieve lookup data");
    }
    ...
    public void postApplicationSearchHandlesValidationFailure() throws Exception {
      ...
      assertThat(mockMvc.perform(post("/application/search").sessionAttr(USER_DETAILS, user)))
          .hasStatusOk()
          .hasViewName("application/application-search")
          .model()
          .containsEntry("feeEarners", feeEarners)
