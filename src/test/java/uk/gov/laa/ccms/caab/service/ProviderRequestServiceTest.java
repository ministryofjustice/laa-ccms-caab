...
class ProviderRequestServiceTest {
  ...
  @InjectMocks private ProviderRequestService providerRequestService;

  @Test
  @DisplayName(
      "submitProviderRequest - Successfully submits a provider request and returns notification ID")
  void submitProviderRequest_Success() {
    ...
    verify(soaApiClient)
        .submitProviderRequest(providerRequestDetail, "testLoginId", "testUserType");
  }

  @Test
  @DisplayName(
      "submitProviderRequest - Throws CaabApplicationException on exception from SoaApiClient")
  void submitProviderRequest_ThrowsException() {
    ...
    final CaabApplicationException exception =
        assertThrows(
