...
public class AddressFormData {
  ...
  /**
   * The house name or number. This field typically contains the building number or name in the
   * address.
   */
  ...
  /** The first line of the address. This usually contains street information. */
  @Size(max = ADDRESS_LINE1_CHARACTER_SIZE)
  private String addressLine1;

  /** The second line of the address. This can be used for additional street or area information. */
  @Size(max = DEFAULT_CHARACTER_SIZE)
