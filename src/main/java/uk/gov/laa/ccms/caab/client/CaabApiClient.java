...
public class CaabApiClient {
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiRetrieveError(
                    e, RESOURCE_TYPE_APPLICATION, "id", id));
  }
  ...
  public Mono<ApplicationDetails> getApplications(
    ...
    Optional.ofNullable(page).ifPresent(p -> queryParams.add("page", String.valueOf(p)));
    Optional.ofNullable(size).ifPresent(s -> queryParams.add("size", String.valueOf(s)));

    return caabApiWebClient
        .get()
        .uri(builder -> builder.path("/applications").queryParams(queryParams).build())
        .retrieve()
        .bodyToMono(ApplicationDetails.class)
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiRetrieveError(
                    e, RESOURCE_TYPE_APPLICATION, queryParams));
  }
  ...
  public Mono<Void> patchApplication(
      final String id, final ApplicationDetail patch, final String loginId) {
    return caabApiWebClient
        .patch()
        .uri("/applications/{id}", id)
        .header("Caab-User-Login-Id", loginId)
   ...
   * @param type the type of data being putted (examples - "application-type", "provider-details",
   *     "correspondence-address")
   * @return a Mono containing application's data
   */
  public Mono<Void> putApplication(
      final String id, final String loginId, final Object data, final String type) {
    return caabApiWebClient
        .put()
   ...
   */
  public Mono<Void> deleteApplication(final String id, final String loginId) {
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiDeleteError(
                    e, RESOURCE_TYPE_APPLICATION, "id", String.valueOf(e)));
  }
   ...
   */
  public Mono<ApplicationType> getApplicationType(final String id) {
    ...
    return caabApiWebClient
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiRetrieveError(
                    e, RESOURCE_TYPE_APPLICATION_TYPE, "application id", id));
  }
   ...
   * @return a Mono containing application's application type
   */
  public Mono<Void> putApplicationType(
      final Integer id, final String loginId, final ApplicationType data) {
    return caabApiWebClient
        .put()
        .uri("/applications/{id}/application-type", id)
        .header("Caab-User-Login-Id", loginId)
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiRetrieveError(
                    e, RESOURCE_TYPE_APPLICATION_TYPE, "application id", String.valueOf(id)));
  }
   ...
   * @return a Mono containing application's application type
   */
  public Mono<ApplicationProviderDetails> getProviderDetails(final String id) {
    return caabApiWebClient
        .get()
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiRetrieveError(
                    e, RESOURCE_TYPE_PROVIDER_DETAIL, "application id", id));
  }
   ...
   */
  public Mono<AddressDetail> getCorrespondenceAddress(final String id) {
    return caabApiWebClient
        .get()
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiRetrieveError(
                    e, RESOURCE_TYPE_CORRESPONDENCE_ADDRESS, "application id", id));
  }
   ...
   */
  public Mono<List<LinkedCaseDetail>> getLinkedCases(final String id) {
    return caabApiWebClient
        .get()
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiRetrieveError(
                    e, RESOURCE_TYPE_LINKED_CASES, "application id", id));
  }
   ...
   */
  public Mono<Void> removeLinkedCase(final String linkedCaseId, final String loginId) {
    return caabApiWebClient
        .delete()
        .uri("/linked-cases/{linkedCaseId}", linkedCaseId)
        .header("Caab-User-Login-Id", loginId)
        .retrieve()
        .bodyToMono(Void.class)
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiDeleteError(
                    e, RESOURCE_TYPE_LINKED_CASES, "linked case id", linkedCaseId));
  }
  ...
  public Mono<Void> addLinkedCase(
      final String applicationId, final LinkedCaseDetail data, final String loginId) {
    return caabApiWebClient
        .post()
        .uri("/applications/{applicationId}/linked-cases", applicationId)
        .header("Caab-User-Login-Id", loginId)
        .contentType(MediaType.APPLICATION_JSON)
        .bodyValue(data)
        .retrieve()
        .bodyToMono(Void.class)
        .onErrorResume(
            e -> caabApiClientErrorHandler.handleApiCreateError(e, RESOURCE_TYPE_LINKED_CASES));
  }
  ...
  public Mono<Void> updateLinkedCase(
      final String linkedCaseId, final LinkedCaseDetail data, final String loginId) {
    return caabApiWebClient
        .patch()
        .uri("/linked-cases/{linkedCaseId}", linkedCaseId)
        .header("Caab-User-Login-Id", loginId)
   ...
   */
  public Mono<CostStructureDetail> getCostStructure(final String id) {
    return caabApiWebClient
        .get()
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiRetrieveError(
                    e, RESOURCE_TYPE_COSTS, "application id", id));
  }
  ...
  public Mono<Void> updateCostStructure(
      final String id, final CostStructureDetail costs, final String loginId) {
    return caabApiWebClient
        .put()
        .uri("/applications/{id}/cost-structure", id)
        .header("Caab-User-Login-Id", loginId)
   ...
   */
  public Mono<List<ProceedingDetail>> getProceedings(final String id) {
    return caabApiWebClient
        .get()
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiRetrieveError(
                    e, RESOURCE_TYPE_PROCEEDINGS, "application id", id));
  }
  ...
  public Mono<Void> updateProceeding(
      final Integer proceedingId, final ProceedingDetail data, final String loginId) {
    return caabApiWebClient
        .patch()
        .uri("/proceedings/{proceeding-id}", proceedingId)
        .header("Caab-User-Login-Id", loginId)
        .contentType(MediaType.APPLICATION_JSON)
        .bodyValue(data)
        .retrieve()
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiUpdateError(
                    e, RESOURCE_TYPE_PROCEEDINGS, "id", String.valueOf(proceedingId)));
  }
  ...
  public Mono<Void> addProceeding(
      final String applicationId, final ProceedingDetail proceeding, final String loginId) {
    return caabApiWebClient
        .post()
        ...
        .bodyToMono(Void.class)
        .onErrorResume(
            e -> caabApiClientErrorHandler.handleApiCreateError(e, RESOURCE_TYPE_PROCEEDINGS));
  }
   ...
   * @return a Mono Void indicating the completion of the delete operation
   */
  public Mono<Void> deleteProceeding(final Integer proceedingId, final String loginId) {
    return caabApiWebClient
        .delete()
        .uri("/proceedings/{proceeding-id}", proceedingId)
        .header("Caab-User-Login-Id", loginId)
   ...
   */
  public Mono<List<ScopeLimitationDetail>> getScopeLimitations(final Integer proceedingId) {
    return caabApiWebClient
        .get()
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiRetrieveError(
                    e,
                    RESOURCE_TYPE_SCOPE_LIMITATIONS,
                    "proceeding id",
                    String.valueOf(proceedingId)));
  }
  ...
  public Mono<Void> updateClient(
      final String clientReferenceId, final String loginId, final BaseClientDetail data) {
    return caabApiWebClient
        .patch()
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiUpdateError(
                    e, RESOURCE_TYPE_CLIENT, "client reference", clientReferenceId));
  }
   ...
   */
  public Mono<List<OpponentDetail>> getOpponents(final String id) {
    return caabApiWebClient
        .get()
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiUpdateError(
                    e, RESOURCE_TYPE_OPPONENTS, "application id", id));
  }
  ...
  public Mono<Void> addOpponent(
      final String applicationId, final OpponentDetail data, final String loginId) {
    return caabApiWebClient
        .post()
        .uri("/applications/{applicationId}/opponents", applicationId)
        .header("Caab-User-Login-Id", loginId)
        .contentType(MediaType.APPLICATION_JSON)
        .bodyValue(data)
        .retrieve()
        .bodyToMono(Void.class)
        .onErrorResume(
            e -> caabApiClientErrorHandler.handleApiCreateError(e, RESOURCE_TYPE_OPPONENTS));
  }
  ...
  public Mono<Void> updateOpponent(
      final Integer opponentId, final OpponentDetail data, final String loginId) {
    return caabApiWebClient
        .patch()
        .uri("/opponents/{opponent-id}", opponentId)
        .header("Caab-User-Login-Id", loginId)
        .contentType(MediaType.APPLICATION_JSON)
        .bodyValue(data)
        .retrieve()
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiUpdateError(
                    e, RESOURCE_TYPE_OPPONENTS, "id", String.valueOf(opponentId)));
  }
   ...
   * @return a Mono Void indicating the completion of the delete operation
   */
  public Mono<Void> deleteOpponent(final Integer opponentId, final String loginId) {
    return caabApiWebClient
        .delete()
        .uri("/opponents/{opponent-id}", opponentId)
        .header("Caab-User-Login-Id", loginId)
   ...
   */
  public Mono<List<PriorAuthorityDetail>> getPriorAuthorities(final String id) {
    return caabApiWebClient
        .get()
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiUpdateError(
                    e, RESOURCE_TYPE_PRIOR_AUTHORITIES, "application id", id));
  }
  ...
  public Mono<Void> addPriorAuthority(
      final String applicationId, final PriorAuthorityDetail priorAuthority, final String loginId) {
    return caabApiWebClient
        .post()
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiCreateError(e, RESOURCE_TYPE_PRIOR_AUTHORITIES));
  }
  ...
  public Mono<Void> updatePriorAuthority(
      final Integer priorAuthorityId, final PriorAuthorityDetail data, final String loginId) {
    return caabApiWebClient
        .patch()
        .uri("/prior-authorities/{prior-authority-id}", priorAuthorityId)
        .header("Caab-User-Login-Id", loginId)
        .contentType(MediaType.APPLICATION_JSON)
        .bodyValue(data)
        .retrieve()
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiUpdateError(
                    e, RESOURCE_TYPE_PRIOR_AUTHORITIES, "id", String.valueOf(priorAuthorityId)));
  }
   ...
   * @return a Mono signaling completion or error handling.
   */
  public Mono<Void> deletePriorAuthority(final Integer priorAuthorityId, final String loginId) {
    return caabApiWebClient
        .delete()
        .uri("/prior-authorities/{prior-authority-id}", priorAuthorityId)
        .header("Caab-User-Login-Id", loginId)
  ...
  public Mono<CaseOutcomeDetails> getCaseOutcomes(
    ...
    return caabApiWebClient
        .get()
        .uri(builder -> builder.path("/case-outcomes").queryParams(queryParams).build())
        .retrieve()
        .bodyToMono(CaseOutcomeDetails.class)
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiRetrieveError(
                    e, RESOURCE_TYPE_CASE_OUTCOME, queryParams));
  }
   ...
   */
  public Mono<CaseOutcomeDetail> getCaseOutcome(final String id) {
    ...
    return caabApiWebClient
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiRetrieveError(
                    e, RESOURCE_TYPE_CASE_OUTCOME, "id", id));
  }
   ...
   * @return a Mono signaling the completion of the application creation
   */
  public Mono<String> createCaseOutcome(final String loginId, final CaseOutcomeDetail caseOutcome) {
   ...
   * @return a Mono Void indicating the completion of the delete operation
   */
  public Mono<Void> deleteCaseOutcome(final Integer caseOutcomeId, final String loginId) {
    return caabApiWebClient
        .delete()
        .uri("/case-outcomes/{case-outcome-id}", caseOutcomeId)
        .header("Caab-User-Login-Id", loginId)
        .retrieve()
        .bodyToMono(Void.class)
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiDeleteError(
                    e, RESOURCE_TYPE_CASE_OUTCOME, "id", String.valueOf(caseOutcomeId)));
  }
  ...
  public Mono<Void> deleteCaseOutcomes(
      final String caseReferenceNumber, final Integer providerId, final String loginId) {
    final MultiValueMap<String, String> queryParams = new LinkedMultiValueMap<>();
    Optional.ofNullable(caseReferenceNumber)
        .ifPresent(ref -> queryParams.add("case-reference-number", caseReferenceNumber));
    Optional.ofNullable(providerId)
  ...
  public Mono<String> createEvidenceDocument(
      final EvidenceDocumentDetail data, final String loginId) {
    return caabApiWebClient
        .post()
        .uri("/evidence")
        .header("Caab-User-Login-Id", loginId)
        ...
        .exchangeToMono(CaabApiClient::getIdResponse)
        .onErrorResume(
            e -> caabApiClientErrorHandler.handleApiCreateError(e, RESOURCE_TYPE_EVIDENCE));
  }
  ...
  /**
   * Fetches the uploaded evidence documents based on the supplied search criteria. This method
   * communicates with the CAAB API client to fetch the evidence documents.
   *
  ...
  public Mono<EvidenceDocumentDetails> getEvidenceDocuments(
    ...
    Optional.ofNullable(documentType).ifPresent(param -> queryParams.add("document-type", param));
    Optional.ofNullable(ccmsModule).ifPresent(param -> queryParams.add("ccms-module", param));
    Optional.ofNullable(transferPending)
        .ifPresent(param -> queryParams.add("transfer-pending", param.toString()));

    return caabApiWebClient
        .get()
        .uri(builder -> builder.path("/evidence").queryParams(queryParams).build())
        .retrieve()
   ...
   * @return a Mono signaling completion or error handling.
   */
  public Mono<Void> deleteEvidenceDocument(final Integer evidenceDocumentId, final String loginId) {
    return caabApiWebClient
        .delete()
        .uri("/evidence/{evidence-document-id}", evidenceDocumentId)
        .header("Caab-User-Login-Id", loginId)
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiDeleteError(
                    e, RESOURCE_TYPE_EVIDENCE, "id", String.valueOf(evidenceDocumentId)));
  }
  ...
  public Mono<String> createNotificationAttachment(
      final NotificationAttachmentDetail data, final String loginId) {
    return caabApiWebClient
        .post()
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiCreateError(
                    e, RESOURCE_TYPE_NOTIFICATION_ATTACHMENTS));
  }
  ...
  public Mono<Void> updateNotificationAttachment(
    ...
    return caabApiWebClient
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiUpdateError(
                    e, RESOURCE_TYPE_NOTIFICATION_ATTACHMENTS, "id", String.valueOf(data.getId())));
  }
  ...
  public Mono<NotificationAttachmentDetails> getNotificationAttachments(
    ...
    Optional.ofNullable(providerId)
        .ifPresent(param -> queryParams.add("provider-id", String.valueOf(param)));
    Optional.ofNullable(documentType).ifPresent(param -> queryParams.add("document-type", param));
    Optional.ofNullable(sendBy).ifPresent(param -> queryParams.add("send-by", param));

    return caabApiWebClient
        .get()
        .uri(builder -> builder.path("/notification-attachments").queryParams(queryParams).build())
        .retrieve()
        .bodyToMono(NotificationAttachmentDetails.class)
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiRetrieveError(
                    e, RESOURCE_TYPE_NOTIFICATION_ATTACHMENTS, queryParams));
  }
  ...
  public Mono<Void> deleteNotificationAttachment(
      final Integer notificationAttachmentId, final String loginId) {
    return caabApiWebClient
        .delete()
        .uri("/notification-attachments/{notification-attachment-id}", notificationAttachmentId)
        .header("Caab-User-Login-Id", loginId)
        ...
        .onErrorResume(
            e ->
                caabApiClientErrorHandler.handleApiDeleteError(
                    e, RESOURCE_TYPE_NOTIFICATION_ATTACHMENTS, "id", String.valueOf(e)));
  }
