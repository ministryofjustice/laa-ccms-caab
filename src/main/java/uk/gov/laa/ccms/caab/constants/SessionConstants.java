...
public class SessionConstants {
   ...
   * application. Used when returning to copy case results screen to prepopulate table of results
   */
   ...
   * application. Used when returning to the client search screen to prepopulate fields
   */
   ...
   * application. Used when returning to client results screen to prepopulate table of results
   */
  ...
  /**
   * Session attribute used to keep track of address search results. Used when returning to client
   * details address screen to prepopulate the results. Used for client and correspondence address
   * search results.
   */
  ...
  /**
   * Session attribute used to keep track of the Case Reference Number, used for case summary page.
   */
  ...
  /**
   * Session attribute used to keep track of organisation search results during the creation of a
   * new application opponent. Used when returning to organisation search results screen to
   * prepopulate table of results
   */
  ...
  /**
   * Session attribute used to keep track of the old proceeding flow data before modifications were
   * made.
   */
  ...
  /**
   * Session attribute used to hold sections data for validation, when clicking complete application
   * button.
   */
