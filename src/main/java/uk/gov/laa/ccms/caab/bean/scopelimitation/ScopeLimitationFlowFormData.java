...
/**
 * This class represents the flow form data of a scope limitation.
 * It includes the action to be performed, the ID and index of the scope limitation,
 * and details about the scope limitation.
 */
@Data
public class ScopeLimitationFlowFormData {
  ...
  /**
   * Constructs a new ScopeLimitationFlowFormData with the specified action type.
   * Initializes the scope limitation details.
   *
