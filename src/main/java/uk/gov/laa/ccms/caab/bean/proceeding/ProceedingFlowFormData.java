...
/**
 * This class represents the flow form data of a proceeding. It includes the action, whether it's
 * amended, whether scope limitations are being edited, the ID of the existing proceeding if any,
 * whether it's a lead proceeding, and details about the matter type, proceeding, and further
 * details.
 */
@Data
public class ProceedingFlowFormData {
  ...
  /**
   * Constructs a new ProceedingFlowFormData with the specified action type. Initializes the matter
   * type details, proceeding details, and further details.
   *
