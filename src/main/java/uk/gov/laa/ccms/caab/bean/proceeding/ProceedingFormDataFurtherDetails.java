...
/**
 * This class represents the further details of a proceeding form data. It includes the client
 * involvement type and its display value, the level of service and its display value, and the type
 * of order and its display value.
 */
@Data
