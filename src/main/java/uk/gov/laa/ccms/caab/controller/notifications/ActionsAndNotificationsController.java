...
public class ActionsAndNotificationsController {
  ...
  public String notificationsCase(
    ...
    String primaryContactLoginId = getPrimaryContactLoginId(ebsCase, user);
    ...
    criteria.setPrimaryContactName(primaryContactLoginId);
  ...
  /**
   * Get the login ID of a case's primary (provider) contact, as used by the "assigned to" filter.
   *
   ...
   * @return the login ID of the primary contact, or an empty String if it cannot be determined, so
   *     that all assignees are searched rather than none.
   */
  private String getPrimaryContactLoginId(ApplicationDetail ebsCase, UserDetail user) {
