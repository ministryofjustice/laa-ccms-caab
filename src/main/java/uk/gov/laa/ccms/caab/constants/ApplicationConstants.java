...
public class ApplicationConstants {
   ...
   */
  public static final String APP_TYPE_EMERGENCY_DEVOLVED_POWERS_DISPLAY = "Emergency Delegated Functions";
   ...
   */
  public static final String APP_TYPE_SUBSTANTIVE_DEVOLVED_POWERS_DISPLAY = "Substantive Delegated Functions";
