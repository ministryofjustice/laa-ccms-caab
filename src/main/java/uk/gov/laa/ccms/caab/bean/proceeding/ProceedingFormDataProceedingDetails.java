...
/**
 * This class represents the details of a proceeding form data. It includes the proceeding type, its
 * display value, the LAR scope, and whether the order type is required.
 */
@Data
